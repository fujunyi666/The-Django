...
class Song(models.Model):
    ...
    song_lyrics = models.CharField('歌词', max_length=20)
    song_file = models.CharField('歌曲文件', max_length=20)
...
class Comment(models.Model):
    ...
    song=models.ForeignKey(Song,on_delete=models.CASCADE,verbose_name='')
