# Generated by Django 2.2.1 on 2019-05-29 10:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song_lyrics', models.CharField(max_length=20, verbose_name='歌词')),
                ('song_file', models.CharField(max_length=20, verbose_name='歌曲文件')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.Song', verbose_name='')),
            ],
        ),
    ]
